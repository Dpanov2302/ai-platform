...
const ImageToImagePage = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setIsLoading(true);
    setTimeout(() => {
      setImgUrl("https://placehold.co/512x320/png?text=Обработанное+изображение");
      setIsLoading(false);
    }, 1200);
  };
      ...
      <main className="max-w-4xl mx-auto px-4 py-24">
        <div className="bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm border border-gray-200 dark:border-gray-700 rounded-xl p-6">
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">
            Модель: Изображение → Изображение
          </h1>
          ...
          {imgUrl && (
            <div className="mt-8">
              ...
              <div className="flex justify-center bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                <img src={imgUrl} alt="Обработанное изображение" className="rounded-md max-h-80 max-w-full shadow" />
              </div>
            </div>
          )}
        </div>
